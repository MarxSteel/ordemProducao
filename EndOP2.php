         ...
         <section class="content">
          <div class="row">
           ...
           <div class="col-xs-3">
            ...
            <section class="content-header">
             <h1>Deseja FINALIZAR esta OP?</h1>
            </section>
            ...
            <div class="col-xs-12">
             <select class="form-control" name="prox" id="prox" required="required">
              ...
              <option value="A">DESEJO FINALIZAR ESTA OP</option>
             </select>                   
            </div>
            <div></div>
          ...
          <?php 
           ...
           $AtualizaOP = "UPDATE hryop_p2 SET opp2_status='F', opp2_datafinal='$DataIniciado', opp2_userfinal='$NomeUserLogado' WHERE opp2_id='$IDEquip'";  
