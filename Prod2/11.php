...
try {
    ...
    $sql = "INSERT INTO hr_op2 (op2_Ordem, op2_Qt, op2_UserC, op2_DtCadastro, op2_DtLimite, op2_Modelo, op2_Status, op2_Priori, op2_Perif, op2_Chic, op2_Obs)
    VALUES ('$NumOrdem', '$Quantidade', '$NomeUserLogado', '$DataSolicita', '$DataLimite', '$Modelo', 'P', '$Prioridade', '$Perifericos', '$Chicotes', '$Obs')";
