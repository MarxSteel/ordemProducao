     ...
     <div class="container">
      <div class="navbar-header">
       <a href="" class="navbar-brand"><b>Henry </b>Equipamentos &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<code>Controle de PCP - Prisma SF R03</code></a>         
...
if(@$_POST["OP_1510"]){
  ...
  //CONFIGURANDO PERIFERICOS
    ...
    $Per1 = $Qt . " UND: 10003009 - Display Gráfico <br />";
    ...
    $Perifericos = $Placa . $Per1 . $Per2 . $Per3 . $Per4 . $Per5 . $Per6 . $Proximidade . $Barras;
  //FIM CONFIGURANDO PERIFERICOS

  //CONFIGURANDO CHICOTES
    $Ch1 = $Qt . " UND: 10008925  - Cabo Display Gráfico<br />";
...
//INÍCIO DA QUERY PARA INSERÇÃO
    ...
    $InsereREP12 = "INSERT INTO hop_p2 (opp2_usuario, opp2_datacadastro, opp2_prioridade, opp2_status, opp2_datalimite, opp2_periferico, opp2_chicote, opp2_obs, opp2_quantidade, opp2_modelo, opp2_hos) VALUES ('$NomeUserLogado', '$DataCadastro', '$Prioridade', 'P', '$DataLimite', '$Perifericos', '$Chicotes', '$Obs', '$Qt', 'Prisma SF R03', '$NumOrdem')";
