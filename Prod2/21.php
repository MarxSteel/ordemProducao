     ...
     <div class="container">
      <div class="navbar-header">
       <a href="" class="navbar-brand"><b>Henry </b>Equipamentos &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<code>Controle de PCP - HEXA A</code></a>         
...
if(@$_POST["OP_1510"]){
  ...
  $Prox = $_POST["prox"];
    if ($Prox == "A") {
      $Proximidade = $Qt . " UND: 10003865 - HRY 13.1.3.10 MODULO PROX - ABATRACK<br />";
    }if ($Prox == "W") {
      $Proximidade = $Qt . " UND: 10003865 - HRY 13.1.3.10 MODULO PROX - WIEGAND<br />";
    } else {
      # NADA AQUI
    }
  ...
  $Bio = $_POST["bio"];
    if ($Bio == "300") {
      $Biometria = $Qt . " UND:  10004706 - Modulo Biometrico Suprema 512K SFM4020 OP4<br />";
    } elseif ($Bio = "9600") {
      $Biometria = $Qt . " UND:  10000791 - Modulo Biometrico SFM3020 4M Suprema<br />";
    } elseif ($Bio = "15000") {
      $Biometria = $Qt . " UND:  10013941 - Modulo Biomerico SFM4020 8M OP5 Suprema<br />";
    } else {
      
    }
    
  //CONFIGURANDO PERIFERICOS
    $Pla1 = $Qt . " UND: 10014676 - Placa Atenas Rev 04<br />";
    $Pla2 = $Qt . " UND: 30093 - Placa Atenas MRP V05<br />";
    $Per1 = $Qt . " UND: 10014732 - Display TFT <br />";
    $Per2 = $Qt . " UND: 10000743 - Leitora Mifare<br />";
    $Per3 = $Qt . " UND: 10003863 - Leitora de Barras<br />";
    $Per4 = $Qt . " UND: 10014050 - Placa Controladora P/mecanismo CB247<br />";
    $Per5 = $Qt . " UND: 10014731 - Placa Sensor de Papel (paper sensor)<br />";
    $Per6 = $Qt . " UND: 10014049 - Impressora Hexa/Onix<br />";
    $Per7 = $Qt . " UND: 30810 - Placa 14033 - RFID";
    $Per8 = $Qt . " UND: 10015220 - Teclado Membrana";


    //CONCATENANDO PERIFÉRICOS
    $Perifericos = $Placa . $Per1 . $Per2 . $Per3 . $Per4 . $Per5 . $Per6 . $Per7 . $Per8 . $Proximidade . $Biometria;
  //FIM CONFIGURANDO PERIFERICOS

  //CONFIGURANDO CHICOTES
    $Ch1 = $Qt . " UND: 100133803 - Cabo do Display do Onix <br />";
